...
pkg_rev=$(porchctl rpkg clone -n default "https://github.com/trhthang/catalog.git/workloads/free5gc/free5gc-cp@$REVISION" --repository regional free5gc-cp | cut -f 1 -d ' ')
