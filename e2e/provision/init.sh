...
REPO=${NEPHIO_REPO:-$(get_metadata nephio-test-infra-repo "https://github.com/trhthang/test-infra.git")}
...
NEPHIO_CATALOG_REPO_URI=${NEPHIO_CATALOG_REPO_URI:-$(get_metadata nephio-catalog-repo-uri "https://github.com/trhthang/catalog.git")}
